...
class TestAtomNeuralFilterModelTrainer(unittest.TestCase):
    ...
    def _get_trainer(self, hparams):
        ...
        with warnings.catch_warnings():
            ...
            trainer = AtomNeuralFilterModelTrainer(dir_wcad_root,
                                                   dir_audio,
                                                   dir_atom_features,
                                                   dir_world_features,
                                                   dir_question_labels,
    ...
    def test_train(self):
        ...
        trainer = self._get_trainer(hparams)
        trainer.init_atom(hparams)
        self.assertFalse(os.path.isfile(os.path.join(hparams.out_dir, hparams.networks_dir, hparams.hparams_atom.model_name)))
    ...
    def test_train_both(self):
        ...
        hparams.hparams_atom.epochs = 1
        hparams.epochs = 3
        hparams.atom_model_path = None
        ...
        for seed in [0]:
            ...
            # Final model saved?
            self.assertTrue(os.path.isfile(os.path.join(hparams.out_dir, hparams.networks_dir, hparams.hparams_atom.model_name)))
    ...
    def test_gen_figure(self):
        ...
        found_files = list([name for name in os.listdir(hparams.out_dir)
                            ...
                            and name.endswith(hparams.model_name + ".FILTERS" + hparams.gen_figure_ext)])
