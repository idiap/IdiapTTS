...
main_dir = "IdiapTTS"
if not any(p.endswith(main_dir) for p in sys.path):
...
# from src.data_preparation.audio.RawWaveformLabelGen import RawWaveformLabelGen
from src.neural_networks.pytorch.ModelHandlerPyTorch import ModelHandlerPyTorch
from src.DataPlotter import DataPlotter
from misc.utils import makedirs_safe, get_gpu_memory_map, sample_linearly
