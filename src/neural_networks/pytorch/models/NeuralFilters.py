...
from src.neural_networks.pytorch.models.IntonationFilters import ComplexModel, CriticalModel, modulus_to_theta
...
class NeuralFilters(nn.Module):
    ...
    def __init__(self, dim_in, dim_out, hparams):
        ...
        self.model_handler_atoms = ModelHandlerPyTorch.ModelHandlerPyTorch(hparams)
        self.model_handler_atoms.load_model(hparams.atom_model_path, hparams.use_gpu, hparams.learning_rate)
